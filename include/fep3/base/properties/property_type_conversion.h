/**
   ...
   @endverbatim
 */
#ifndef __FEP_COMP_PROPERTY_TYPE_CONVERSION_H
#define __FEP_COMP_PROPERTY_TYPE_CONVERSION_H
...
namespace fep
{
    ...
    /**
     * @brief spezialized DefaultPropertyTypeConversion for type bool. Can be used for @ref PropertyValue.
     * 
     */
    template<>
    ...
    /**
     * @brief spezialized DefaultPropertyTypeConversion for type int32_t. Can be used for @ref PropertyValue.
     * 
     */
    template<>
    ...
    /**
     * @brief spezialized DefaultPropertyTypeConversion for type double. Can be used for @ref PropertyValue.
     * 
     */
    template<>
...
#endif //__FEP_COMP_PROPERTY_TYPE_CONVERSION_H
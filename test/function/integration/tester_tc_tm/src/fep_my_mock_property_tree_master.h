...
#ifndef _FEP_TEST_MY_MOCK_PROPERTY_TREE_MASTER_H_INC_
#define _FEP_TEST_MY_MOCK_PROPERTY_TREE_MASTER_H_INC_
...
class cMyMockPropertyTreeMaster : public cMockPropertyTree
{
public:
    cMyMockPropertyTreeMaster()
        ...
        , m_oAckWaitTimeoutProperty(FEP_TIMING_MASTER_CLIENT_TIMEOUT, 10.0)
    {
    }
...
public:
    virtual fep::IProperty const * GetProperty(char const * strPropPath) const
    {
        ...
        {
            return &m_oAckWaitTimeoutProperty;
        }
...
public:
    ...
    fep::cProperty m_oAckWaitTimeoutProperty;
};

#endif // _FEP_TEST_MY_MOCK_PROPERTY_TREE_MASTER_H_INC_

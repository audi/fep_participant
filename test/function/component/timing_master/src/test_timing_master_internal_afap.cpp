...
/*
* Test Case:   TestTimingMaster.InternalStepTrigger_AsFastAsPossibleMode
* Test ID:     1.1
* Test Title:  Test Timing Master with Internal Step Trigger using as fast as possible mode
* Description: The timing master is using the internal step trigger to
*              trigger the timing client as fast as possible.
* Strategy:    Test if the mocked timing client is receiving the
*              expected triggering.
* Passed If:   no errors occur
* Ticket:      -
* Requirement: FEPSDK-1553 FEPSDK-1757 FEPSDK-1751 FEPSDK-1753 FEPSDK-1759
*/

/**
 * @req_id "FEPSDK-1553 FEPSDK-1757 FEPSDK-1752 FEPSDK-1751 FEPSDK-1753 FEPSDK-1759"
 */
TEST_F(TestTimingMaster, InternalStepTrigger_AsFastAsPossibleMode)
{
    using namespace fep;
    using namespace fep::timing;

...
*/
/*
* Test Case:   TestDefaultInitializationForArrays
* Test ID:     1.3
* Test Title:  Initialization Tests with Default Values inside arrays
 ...
 * @req_id "FEPSDK-1577"
 */
TEST(cTesterFepDataSample, TestDefaultInitializationForArrays)
{
    ...
    ASSERT_EQ(a_util::result::SUCCESS, poCSR->RegisterSignal(fep::cUserSignalOptions("TestSignal3b",
        SD_Input, "tTestSignal3b"), hHandle));
    ...
    // Checking values
    ddl::CodecFactory oFactory("tTestSignal3b", s_strDescription.c_str());
    ...
    for (int i= 0; i< 16; ++i) 
    {
        ...
        {
            char v;
            ASSERT_EQ(a_util::result::SUCCESS, ddl::access_element::get_value(oCoder, a_util::strings::format("text[%d]", i), &v).getErrorCode());
            ASSERT_TRUE(v == 42);
        }
    }

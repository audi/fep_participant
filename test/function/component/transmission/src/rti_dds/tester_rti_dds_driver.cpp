/**
* Implementation of the tester for the FEP RTI_DDS Transmission Driver
*
* @file
...
/**
* Test Case:   TestData_RTI_DDS
* Test ID:     1.0
* Test Title:  Test transmission of data
* Description: Test transmission of data with the RTI_DDS driver
...
*/
/**
 * @req_id "FEPSDK-1520 FEPSDK-1521 FEPSDK-1522 FEPSDK-1694 FEPSDK-1740"
 */
TEST(DriverTester_RTI_DDS, TestData_RTI_DDS)
{
    cDriverTester::TestData(fep::TT_RTI_DDS);
}

/**
* Test Case:   TestRxSampleSizeMismatch_RTI_DDS
* Test ID:     1.2
...
*/
/**
 * @req_id "FEPSDK-1531 FEPSDK-1740"
 */
TEST(DriverTester_RTI_DDS, TestRxSampleSizeMismatch_RTI_DDS)
{
    cDriverTester::TestRxSampleSizeMismatch(fep::TT_RTI_DDS);
}

/**
* Test Case:   TestMessageAfterCreate_RTI_DDS
* Test ID:     1.3
...
*/
/**
 * @req_id "FEPSDK-1518 FEPSDK-1740"
 */
TEST(DriverTester_RTI_DDS, TestMessageAfterCreate_RTI_DDS)
{
    cDriverTester::TestMessageAfterCreate(fep::TT_RTI_DDS);
}

/**
* Test Case:   TestVariableSignalSize_RTI_DDS
* Test ID:     1.4
...
*/
/**
 * @req_id "FEPSDK-1726 FEPSDK-1740"
 */
TEST(DriverTester_RTI_DDS, TestVariableSignalSize_RTI_DDS)
{
    cDriverTester::TestVariableSignalSize(fep::TT_RTI_DDS);
}
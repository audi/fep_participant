...
{
    fep::cModuleOptions oModuleOptions("ServerElement");
    ...
    std::string strElementName = "ServerElement";
    if (nElementNumber > 0)
    {
        strElementName = a_util::strings::format("ServerElement%d", nElementNumber);
    }

/**
   ...
   @endverbatim
 */
#ifndef _FEP_ZMQ__DRIVER_OPTIONS_VERIFIER_H_
#define _FEP_ZMQ__DRIVER_OPTIONS_VERIFIER_H_
...
namespace fep
{
    ...
    {
        /**
        * The \c ddsV2::cZMQDriverOptionsVerifier interface is queried for the existence and validity of a specific option.
        */
        class cZMQDriverOptionsVerifier : public IOptionsVerifier
        {
            /**
...
#endif //_FEP_ZMQ__DRIVER_V2_OPTIONS_VERIFIER_H_

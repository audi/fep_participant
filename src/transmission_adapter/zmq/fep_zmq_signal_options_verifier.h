/**
   ...
   @endverbatim
 */
#ifndef _FEP_ZMQ_SIGNAL_OPTIONS_VERIFIER_H_
#define _FEP_ZMQ_SIGNAL_OPTIONS_VERIFIER_H_
namespace fep
{ 
    namespace zmq
    {
        /**
        * The \c ddsV2::ZMQSignalOptionsVerifier interface is queried for the existence and validity of a specific option.
        */
        class ZMQSignalOptionsVerifier : public IOptionsVerifier
        {
            /**
            ...
            */
            bool CheckOption(const std::string& strOptionName, const bool &bValue) const
            {
                ...
                else if ("IsVariableSignalSize" == strOptionName)
                {
                    bRes = true;
                }
...
#endif // _FEP_ZMQ_V2_SIGNAL_OPTIONS_VERIFIER_H_
